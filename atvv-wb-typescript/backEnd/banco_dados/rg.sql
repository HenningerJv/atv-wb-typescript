...
CREATE TABLE `rg` (
  `rg-cod` int NOT NULL AUTO_INCREMENT,
  `rg-numero` varchar(12) NOT NULL,
  `rg-data_emissao` date NOT NULL,
  `cli-cod` int NOT NULL,
  PRIMARY KEY (`rg-cod`),
  KEY `fk_cliente_rg` (`cli-cod`),
  CONSTRAINT `fk_cliente_rg` FOREIGN KEY (`cli-cod`) REFERENCES `cliente` (`cli-cod`) ON DELETE CASCADE
